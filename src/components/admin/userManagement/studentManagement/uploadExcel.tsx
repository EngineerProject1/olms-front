...
import { Button, List, Progress, Spin, Typography, Upload } from 'antd'
...
export function UploadExcel(props: {
  ...
  const excelImport = async (file: any) => {
    ...
    let res = await axios.post('/import', formData)
    console.log(res)
